...
function mimc_cipher(xL_in: usize, xR_in: usize, k_in: usize, xL_out: usize, xR_out: usize): void {
    ...
    let num_rounds = round_constants.length;
    ...
    let c = (new Uint8Array(SIZE_F)).buffer as usize;
    ...
    debug_mem(round_constants.buffer as usize + SIZE_F, SIZE_F);

    //debug_mem(round_constants.buffer as usize + SIZE_F * 2, SIZE_F);
    ...
    for (let i = 0; i < num_rounds; i++) {
        ...
        let c = round_constants.buffer as usize + SIZE_F * i;
...
export function main(): i32 {
    // k0 = 0
    // let k0 = new Uint8Array(SIZE_F) as usize;
    //bn128_frm_zero(k0); // necessary?

    // let kL_in = new Uint8Array(SIZE_F) as usize;
    // let kR_in = new Uint8Array(SIZE_F) as usize;
